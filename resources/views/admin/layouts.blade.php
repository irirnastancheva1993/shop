    ...
    <div class="container">
        <div class="navbar-header">
            <ul class="nav navbar-nav">
                ...
                <li><a href="/shop/public/admin/pages">Страницы</a></li>
                <li><a href="/shop/public/admin/orders">Заказы</a></li>
            </ul>
        </div>
        <div class="collapse navbar-collapse" id="app-navbar-collapse">
            ...
            <ul class="nav navbar-nav navbar-right">
                @if (Auth::guest())
                    ...
                    <li><a href="{{ url('/admin/log') }}"><span class="glyphicon glyphicon-log-in" aria-hidden="true"></span> Вход</a></li>
                @else
                    <li class="dropdown">
